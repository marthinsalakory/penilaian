...
if (isset($_POST["delete"])) {
    ...
    if (delete($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'tidak_lulus.php';
        </script>
        ";
    } else {
        echo "
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Daftar Ketidaklulusan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Data Ketidaklulusan</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-success">
                            <h3 class="card-title">Daftar Nilai Tidak Lulus</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
